...
<header class="my-4 hidden w-48 shrink-0 flex-col justify-between gap-8 pl-4 sm:flex xl:ml-32">
    ...
    <div class="flex flex-col gap-6">
        <button class="bg-pixl hover:bg-pixl/90 active:bg-pixl/95 text-pixl-dark border border-transparent px-4 py-3 text-sm">Post</button>
        <!-- User controls -->
        <div class="flex gap-3.5">
            <a href="/profile" class="shrink-0">
                <img src="{{ asset('images/adrian.png') }}" alt="Avatar for Adrian" class="size-11 object-cover" />
            </a>
...
<main class="-mx-4 flex grow flex-col gap-4 overflow-y-auto px-4 py-4">
    ...
    <header>
        ...
        <div class="-mt-10 flex flex-wrap items-end justify-between gap-4 md:-mt-16">
            ...
            <a href="#" class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border-pixl/50 hover:border-pixl/60 active:border-pixl/75 text-pixl border px-2 py-1 text-sm">
                Edit Profile
            </a>
        </div>
            ...
            <div class="grow pt-1.5">
                <div class="border-pixl-light/10 border-b pb-5">
                    ...
                    <div class="[&_a]:text-pixl mt-4 flex flex-col gap-3 text-sm [&_a]:hover:underline">
                        ...
                        <img src="{{ asset('images/simon-chilling.png') }}" alt="" />
                    </div>
                    ...
                    <div class="border-pixl-light/10 bg-pixl-light/[3%] mt-8 flex items-start gap-4 border-t p-4">
                        ...
                        <form class="grow" action="">
                            ...
                            <textarea class="w-full resize-none text-sm" rows="5" name="reply" id="reply" placeholder="Reply to Michael's post"></textarea>
                            <div class="flex items-center justify-between gap-4">
