    ...
    <div class="flex w-full flex-col items-center justify-between gap-8 md:flex-row md:gap-16">
        ...
        <div>
            <div class="flex items-baseline gap-3">
                ...
                <div aria-hidden="true" class="text-pixl relative hidden text-4xl uppercase md:block">
                    <!-- Top -->
        ...
        <div class="max-w-full pb-16 min-[360px]:w-72 sm:w-80">
            <h1 class="text-pixl text-center text-2xl sm:text-3xl md:text-left">A place for the cool squares.</h1>
            <div class="mt-8 flex flex-col gap-3 text-center sm:mt-12 md:mt-16 md:w-68">
                <a href="/feed" class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border-pixl/50 hover:border-pixl/60 active:border-pixl/75 text-pixl border px-4 py-1.5">
                    Sign in with Google
                </a>
                <a href="/feed" class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border-pixl/50 hover:border-pixl/60 active:border-pixl/75 text-pixl border px-4 py-1.5">
                    Sign in with Apple
                ...
                <p>or</p>
                <a href="/feed" class="bg-pixl hover:bg-pixl/90 active:bg-pixl/95 text-pixl-dark border border-transparent px-4 py-1.5"> Create an Account </a>
                <p class="mt-12 text-left text-sm sm:mt-16 md:mt-20">Already have an Account?</p>
                <a href="/feed" class="bg-pixl hover:bg-pixl/90 active:bg-pixl/95 text-pixl-dark border border-transparent px-4 py-1.5"> Sign in </a>
            </div>
        </div>
    </div>
</main>
...
<footer class="relative pb-3 md:fixed md:inset-x-0 md:bottom-0">
    <div class="text-pixl flex flex-col items-center gap-1.5 p-4 text-center">
        ...
        <p class="text-xs opacity-50">*except for badgers, they're $&@*holes.</p>
    </div>
    ...
    <svg class="absolute right-4 bottom-8 w-7 grayscale max-sm:hidden" viewBox="0 0 29 43" xmlns="http://www.w3.org/2000/svg" fill="none">
        <g fill="#ECA749" opacity=".5" style="mix-blend-mode: luminosity">
            <path d="M7.058 0H0v7.058h7.058V0Zm0 7.058H0v7.059h7.058V7.058ZM28.234 0h-7.058v7.058h7.058V0Zm0 7.059h-7.058v7.058h7.058V7.059ZM7.058 28.233H0v7.059h7.058v-7.059Z"></path>
