        ...
        <div class="border-pixl-light/10 border-b pb-5">
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <p>
                        <a href="/profile" class="hover:underline">{{ $item->profile->displayName }}</a>
                    </p>
                    <p class="text-pixl-light/40 text-xs">{{ $item->postedDateTime }}</p>
                    <p>
                        <a href="/profile" class="text-pixl-light/40 hover:text-pixl-light/60 text-xs">{{ $item->profile->handle }}</a>
                    </p>
                </div>
