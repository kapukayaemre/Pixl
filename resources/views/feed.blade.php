    ...
    <div class="overflow-y-auto pl-4">
        ...
        <a href="/">
            <svg class="h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 182 61" fill="none">
                ...
                ></path>
                <path fill="#ECA749" d="M110.917 20.166h-10.083V30.25h10.083V20.166Zm10.082 10.084h-10.083v10.083h10.083V30.25Z"></path>
                <path fill="#EEE" d="M151.249 0h-10.083v10.083h10.083V0Zm0 10.084h-10.083v10.083h10.083V10.083Z"></path>
                <path fill="#EEE" d="M151.249 20.166h-10.083V30.25h10.083V20.166Zm0 10.084h-10.083v10.083h10.083V30.25Zm0 10.084h-10.083v10.083h10.083V40.333Z"></path>
                <path fill="#EEE" d="M151.249 50.416h-10.083V60.5h10.083V50.416Zm10.084.001H151.25V60.5h10.083V50.417Zm10.084-.001h-10.083V60.5h10.083V50.416Z"></path>
        ...
        <nav class="mt-10">
            <ul class="flex flex-col gap-3.5">
                ...
                <li>
                    <a class="hover:underline" href="#">Lists</a>
                </li>
                <li>
                    <a class="hover:underline" href="#">Bookmarks</a>
                </li>
                <li>
                    <a class="hover:underline" href="#">Jobs</a>
                </li>
                <li>
                    <a class="hover:underline" href="#">Communities</a>
                </li>
                <li>
                    <a class="hover:underline" href="#">Premium</a>
                </li>
                <li>
...
<main class="-mx-4 flex grow flex-col gap-4 overflow-y-auto px-4 py-4">
    <div class="h-full">
        <nav class="overflow-x-auto [scrollbar-width:none]">
            <ul class="flex min-w-max justify-end gap-8 text-sm">
                ...
                <li>
                    <a href="#" class="text-pixl-light/60 hover:text-pixl-light/80">Idea streams</a>
                </li>
                <li>
                    <a href="#" class="text-pixl-light/60 hover:text-pixl-light/80">Following</a>
                </li>
            </ul>
        </nav>
    </div>
    ...
    <div class="border-pixl-light/10 mt-8 flex items-start gap-4 border-b pb-4">
        ...
        <form action="" class="grow">
            ...
            <div class="flex items-center justify-between gap-4">
                    ...
                    <button type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6" fill="none" viewBox="0 0 24 19">
                            <g fill="#EEE" clip-path="url(#a)">
                                <path d="M1.598 1.584h-1.6v1.584h1.6V1.584ZM3.196 0h-1.6v1.584h1.6V0Zm1.601 0h-1.6v1.584h1.6V0ZM6.4 0H4.8v1.584h1.6V0ZM8 0H6.4v1.584H8V0Z" />
                                ...
                                <path d="M20.796 0h-1.6v1.584h1.6V0ZM22.4 0h-1.6v1.584h1.6V0ZM1.598 3.168h-1.6V4.75h1.6V3.168Zm0 1.584h-1.6v1.583h1.6V4.752Z" />
                                <path
                                ...
                                <path d="M1.598 15.834h-1.6v1.583h1.6v-1.583Zm22.403-14.25h-1.6v1.584h1.6V1.584Zm0 1.584h-1.6V4.75h1.6V3.168Zm0 1.584h-1.6v1.583h1.6V4.752Z" />
                                <path
                                ...
                                <path d="M12.794 17.418h-1.6V19h1.6v-1.583Zm1.606 0h-1.6V19h1.6v-1.583Zm1.6 0h-1.6V19H16v-1.583Zm1.6 0H16V19h1.6v-1.583Z" />
                    ...
                    <button type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-6" viewBox="0 0 24 19">
                            <g fill="#EEE" clip-path="url(#a)">
                                ...
                                <path d="M1.602 4.75h-1.6v1.584h1.6V4.751Zm0 1.584h-1.6v1.583h1.6V6.334Zm0 1.584h-1.6V9.5h1.6V7.918Zm0 1.582h-1.6v1.584h1.6V9.5Z" />
                                <path
                                ...
                                <path d="M24 14.25h-1.6v1.583H24V14.25Zm0 1.583h-1.6v1.584H24v-1.584ZM3.202 17.417h-1.6V19h1.6v-1.583Zm1.601 0h-1.6V19h1.6v-1.583Z" />
                ...
                <button type="submit" class="bg-pixl hover:bg-pixl/90 active:bg-pixl/95 text-pixl-dark border border-transparent px-4 py-1 text-sm">Post</button>
            </div>
        </form>
    </div>
    ...
    <ol class="mt-4">
        ...
        <li class="flex items-start gap-4 not-first:pt-2.5">
            <a href="/profile" class="shrink-0">
                <img src="{{ asset('images/michael.png') }}" alt="Avatar for Michael" class="size-10 object-cover" />
            </a>
            ...
            <div class="grow pt-1.5">
                <div class="border-pixl-light/10 border-b pb-5">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div class="flex items-center gap-2.5">
                            <p>
                                <a href="/profile" class="hover:underline">Michael</a>
                            </p>
                            <p class="text-pixl-light/40 text-xs">3h</p>
                            <p>
                                <a href="/profile" class="text-pixl-light/40 hover:text-pixl-light/60 text-xs">@mmich_jj</a>
                            </p>
                        </div>
                    ...
                    <div class="[&_a]:text-pixl mt-4 flex flex-col gap-3 text-sm [&_a]:hover:underline">
                        ...
                        <img src="{{ asset('images/simon-chilling.png') }}" alt="Simon" />
                    </div>
                                ...
                                <button aria-label="Like" class="hover:text-pixl">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="h-[17px]" viewBox="0 0 20 17">
                                        <g fill="currentColor" clip-path="url(#a)">
                                            <path d="M5.714 0H2.857v2.857h2.857V0Zm2.858 0H5.714v2.857h2.858V0Zm2.857 2.858H8.57v2.857h2.858V2.858ZM14.288 0h-2.857v2.857h2.857V0Z" />
                            ...
                            <div class="flex items-center gap-1">
                                <button aria-label="Re-post" class="hover:text-pixl">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="h-[17px]" viewBox="0 0 20 17">
                                        ...
                                        <path fill="currentColor" d="M8.57 3.857H7.142v1.429H8.57V3.857Zm1.43 0H8.572v1.429H10V3.857ZM5.712 2.429H4.284v1.429h1.428V2.429Z" />
                                        ...
                                        <path fill="currentColor" d="M5.712 6.714H4.284v1.429h1.428V6.714Zm0 1.429H4.284v1.429h1.428V8.143Zm1.432 1.429H5.716V11h1.428V9.57Z" />
                                        <path
                                            fill="currentColor"
                                ...
                                <button aria-label="Share" class="hover:text-pixl">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="h-[17px]" viewBox="0 0 19 17">
                                        <g fill="currentColor" clip-path="url(#a)">
                                            ...
                                            <path d="M6.373 4.25H4.248v2.125h2.125V4.25Zm0-2.125H4.248V4.25h2.125V2.125Zm2.127 0H6.375V4.25H8.5V2.125ZM8.5 0H6.375v2.125H8.5V0Z" />
                    ...
                    <div class="border-pixl-light/10 bg-pixl-light/[3%] mt-8 flex items-start gap-4 border-t p-4">
                        ...
                        <form action="" class="grow">
                            <label for="reply" class="sr-only">Reply body</label>
                            <textarea class="w-full resize-none text-sm" name="reply" id="reply" placeholder="Reply to Michael's post" rows="5"></textarea>
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex gap-4">
                                    <!-- Image Icon -->
                                    <button type="button">
                                ...
                                <button type="submit" class="bg-pixl/10 hover:bg-pixl/15 active:bg-pixl/20 text-pixl border border-transparent px-4 py-1 text-sm">Post</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <ol>
                    ...
                    <li class="group/li relative flex items-start gap-4 pt-4">
                        <!-- group namespacing group/yourName -->
                        <!-- Line-through -->
                        ...
                        <a href="/profile" class="isolate shrink-0">
                            <img src="{{ asset('images/simon-chilling.png') }}" alt="Avatar for Simon" class="size-10 object-cover" />
                        </a>
                        ...
                        <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex items-center gap-2.5">
                                    <p>
                                        <a href="/profile" class="hover:underline">Simon</a>
                                    </p>
                                    <p class="text-pixl-light/40 text-xs">1h</p>
                                    <p>
                                        <a href="/profile" class="text-pixl-light/40 hover:text-pixl-light/60 text-xs">@simonswiss</a>
                                    </p>
                                </div>
        ...
        <li class="flex items-start gap-4 not-first:pt-2.5">
            <a href="/profile" class="shrink-0">
                <img src="{{ asset('images/adelle.png') }}" alt="Avatar for Adelle" class="size-10 object-cover" />
            </a>
            ...
            <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
                <div class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-2.5">
                        <p>
                            <a href="/profile" class="hover:underline">Adelle</a>
                        </p>
                        <p class="text-pixl-light/40 text-xs">2h</p>
                        <p>
                            <a href="/profile" class="text-pixl-light/40 hover:text-pixl-light/60 text-xs">@add-elle</a>
                        </p>
                    </div>
                ...
                <div class="mt-4 flex flex-col gap-3 text-sm">
                    <p>
                        Presumably, if you're watching this series, you've already made the decision to embrace all that Laravel has to offer. However, if you're still on the fence, give me
                        just a moment to sell you on why I believe Laravel is the best framework choice in the PHP world.
                    </p>
                </div>
...
<aside class="-mx-4 my-4 hidden w-80 shrink-0 overflow-y-auto px-4 lg:block">
    <input type="text" placeholder="#Search an idea or pixl" class="border-pixl-light/10 w-full text-sm" />
    <hr class="border-pixl-light/10 mt-2" />

    <!-- Artists to follow -->
    <div class="border-pixl-light/10 mt-10 border p-4">
        <h2 class="text-pixl-light/60 text-sm">Artist to follow</h2>
        <ol class="mt-4 flex flex-col gap-4">
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img src="{{ asset('images/alessia.png') }}" alt="Avatar of Alessia" class="size-8 object-cover" />
                    <p class="truncate text-sm">alessia_draws</p>
                </div>

                <button class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border-pixl/50 hover:border-pixl/60 active:border-pixl/75 text-pixl border px-2 py-1 text-sm">
                    Follow
                </button>
            </li>
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img src="{{ asset('images/anne.png') }}" alt="Avatar of Anne" class="size-8 object-cover" />
            ...
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img src="{{ asset('images/mr-anderson.png') }}" alt="Avatar of Mr Anderson" class="size-8 object-cover" />
            ...
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img src="{{ asset('images/michael.png') }}" alt="Avatar of Michael" class="size-8 object-cover" />
    ...
    <div class="border-pixl-light/10 mt-4 border p-4">
        ...
        <ol class="mt-4 flex flex-col gap-2.5">
            ...
            <li class="flex items-center justify-between gap-4">
                <p class="truncate text-sm">Tips for Illustrators</p>
            ...
            <li class="flex items-center justify-between gap-4">
                <p class="truncate text-sm">Let's talk raw&real</p>
